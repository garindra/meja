...
func DecodeSessionAttach(payload []byte) (SessionAttach, error) {
	...
	return SessionAttach{Version: int(version), Token: token, Cols: uint16(cols), Rows: uint16(rows)}, nil
}
...
func DecodeSessionAttachOK(payload []byte) (SessionAttachOK, error) {
	...
	return SessionAttachOK{Version: int(version), ResumeToken: token}, nil
}
...
func DecodeSessionResume(payload []byte) (SessionResume, error) {
	...
	return SessionResume{Version: int(version), ResumeToken: token, Cols: uint16(cols), Rows: uint16(rows)}, nil
}
...
func DecodeSessionResumeOK(payload []byte) (SessionResumeOK, error) {
	...
	return SessionResumeOK{Version: int(version)}, nil
}
