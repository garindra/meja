...
var atomicFieldContract = map[string]string{
	...
	"server.paneRenderMetrics.ptyDrainCompiledFrames":     "atomic.Uint64",
	"server.paneRenderMetrics.ptyDrainCancelledCells":     "atomic.Uint64",
	"server.paneRenderMetrics.publications":               "atomic.Uint64",
	"server.paneRenderMetrics.compiledFrames":             "atomic.Uint64",
	...
	"server.paneRenderMetrics.rawCommandPayloadBytes":     "atomic.Uint64",
	"server.paneRenderMetrics.encodedPayloadBytes":        "atomic.Uint64",
	"server.paneRenderMetrics.completeFramedBytes":        "atomic.Uint64",
	"server.paneRenderMetrics.rawSelectedFrames":          "atomic.Uint64",
	"server.paneRenderMetrics.zlibSelectedFrames":         "atomic.Uint64",
	"server.paneRenderMetrics.compressionDurationNanos":   "atomic.Uint64",
