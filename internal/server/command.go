...
func registeredCommands() []commandDefinition {
	return []commandDefinition{
		...
		{name: "send-keys", aliases: []string{"send"}, usage: "send-keys [-t session] [-X copy-mode-command | -l] key...", description: "Send keys or run a copy-mode command in the active pane.", execute: sessionCommand(sessionTarget, handleSendKeysCommand)},
		{name: "capture-pane", aliases: []string{"capturep"}, usage: "capture-pane [-t session] [-p] [-b buffer-name] [-S start-line] [-E end-line] [-e] [-C] [-J] [-N]", description: "Capture the active pane into stdout or a paste buffer.", execute: capturePaneCommand()},
		{name: "list-panes", aliases: []string{"lsp"}, usage: "list-panes [-t session] [-F format]", description: "List panes and pane mode values.", execute: listPanesCommand()},
		{name: "set-buffer", aliases: []string{"setb"}, usage: "set-buffer [-a] [-b buffer-name] [-n new-buffer-name] data", description: "Create or update a paste buffer.", execute: handleSetBufferCommand},
		{name: "show-buffer", aliases: []string{"showb"}, usage: "show-buffer [-b buffer-name]", description: "Print a paste buffer.", execute: handleShowBufferCommand},
		{name: "list-buffers", aliases: []string{"lsb"}, usage: "list-buffers", description: "List paste buffers.", execute: handleListBuffersCommand},
		{name: "delete-buffer", aliases: []string{"deleteb"}, usage: "delete-buffer [-b buffer-name]", description: "Delete a paste buffer.", execute: handleDeleteBufferCommand},
		{name: "load-buffer", aliases: []string{"loadb"}, usage: "load-buffer [-b buffer-name] path", description: "Load a file into a paste buffer.", execute: handleLoadBufferCommand},
		{name: "save-buffer", aliases: []string{"saveb"}, usage: "save-buffer [-a] [-b buffer-name] path", description: "Save a paste buffer to a file.", execute: handleSaveBufferCommand},
		{name: "paste-buffer", aliases: []string{"pasteb"}, usage: "paste-buffer [-t session] [-b buffer-name] [-dprS] [-s separator]", description: "Paste a buffer into the active pane.", execute: sessionCommand(sessionTarget, handlePasteBufferCommand)},
