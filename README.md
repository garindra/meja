...
```sh
curl -fsSL https://github.com/garindra/meja/releases/download/v0.0.19/meja_0.0.19_linux_amd64.tar.gz \
...
```sh
curl -fsSL https://github.com/garindra/meja/releases/download/v0.0.19/meja_0.0.19_darwin_arm64.tar.gz \
  | sudo tar -xz -C /usr/local/bin meja
```
